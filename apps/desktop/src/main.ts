      ...
      <article class="panel view-card">
        ...
        <div class="view-body">
          ...
          <section class="view-section">
            ...
            <dl class="help-list">
              <dt>Rooms</dt><dd>Teams of sessions with a shared feed. <b>Post to feed</b> is a bulletin board: nobody is interrupted, the harnesses read it. <b>Send</b> delivers the text into members' terminals as typed input. It is refused while a member sits on a question (trust, approval, plan chooser), is still starting, or has just lost its connection — the red line names the member, says what PRIM-1 saw and what clears it. A send to all members is all-or-nothing: if one member is refused, nobody receives it; send to the others one at a time meanwhile. Creating a room, you choose whether the room brief is typed to members automatically and can edit its text.</dd>
