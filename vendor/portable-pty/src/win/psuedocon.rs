...
use winapi::um::winbase::{
    CREATE_BREAKAWAY_FROM_JOB, CREATE_UNICODE_ENVIRONMENT, EXTENDED_STARTUPINFO_PRESENT,
...
const PROCESS_CREATION_FLAGS: DWORD = EXTENDED_STARTUPINFO_PRESENT | CREATE_UNICODE_ENVIRONMENT;
const _: () = assert!(PROCESS_CREATION_FLAGS & CREATE_BREAKAWAY_FROM_JOB == 0);
...
impl PsuedoCon {
    ...
    pub fn spawn_command(&self, cmd: CommandBuilder) -> anyhow::Result<WinChild> {
        self.spawn_command_impl(cmd, None)
    }
    ...
    pub fn spawn_command_in_job(
        ...
        self.spawn_command_impl(cmd, Some(job))
    }
