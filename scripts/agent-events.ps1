param(
  ...
  [string[]]$IncludeKinds = @("routed_message", "route_delivery", "pane_signal", "session_state", "session_exit", "session_work_state", "system_log", "sideband_request_lifecycle", "request_ack", "request_ack_timeout"),
