...
Assert-Equal ($actionValidateSet[0].ValidValues -join ",") "ping,wait_quiet,input,key,room_read,room_post,room_deliver" "The script action surface must stay closed to the seven pane-local actions."
